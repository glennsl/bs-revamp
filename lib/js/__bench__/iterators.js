...
function run(param) {
  new Benchmark.Suite("iterators").suite("Imperative (baseline)", (function (param) {
                      var $$break = false;
                      while(!$$break) {
                        var result = re.exec("bananas");
                        if (result !== null) {
                    ...
                    })).suite("Seq", (function (param) {
                    return forEach((function (prim) {
                                  
                                }), exec("bananas", re));
                  })).suite("Seq + map", (function (param) {
                  return forEach((function (prim) {
                                
                              }), matches("bananas", re));
                })).suite("Gen", (function (param) {
                return forEach$1((function (prim) {
                              
                            }), exec$1("bananas", re));
              })).suite("Internal", (function (param) {
