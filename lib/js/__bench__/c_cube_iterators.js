...
new Benchmark.Suite("tags").add("Gen", (function (param) {
                                  f_gen(undefined);
                                  
                                })).add("g", (function (param) {
                                f_g(undefined);
                                
                              })).add("g_exn", (function (param) {
                              f_g_exn(undefined);
                              
                            })).add("core.sequence", (function (param) {
                            f_core(undefined);
                            
                          })).add("cps", (function (param) {
                          f_cps(undefined);
                          
                        })).add("cps2", (function (param) {
                        f_cps2(undefined);
                        
                      })).add("fold", (function (param) {
                      f_fold(undefined);
                      
                    })).add("sequence", (function (param) {
                    f_seq(undefined);
                    
                  })).add("list", (function (param) {
                  f_list(undefined);
                  
                })).add("lazy_list", (function (param) {
                f_llist(undefined);
                
              })).add("ulist", (function (param) {
              f_ulist(undefined);
              
            })).add("uncons", (function (param) {
            f_uncons(undefined);
