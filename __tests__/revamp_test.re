...
describe("Compiled", () => {
  test("make - flags", () => {
    let result = 
      {js|
        ...
        Two Møøse
      |js}
      |> Revamp.Compiled.matches(Revamp.Compiled.make(~flags=Revamp.[IgnoreCase, Unicode, MultiLine], {js|o\\w+ møøse$|js}))
      |> List.fromSeq;
  ...
  test("make - no flags", () => {
    let result = 
      {js|
        ...
        Two Møøse
      |js}
      |> Revamp.Compiled.matches(Revamp.Compiled.make({js|\\w+ Møøse|js}))
      |> List.fromSeq;
  ...
  test("test - raise Invalid_argument if given partially used global regexp object", () => {
    let re = [%re "/o/g"];
    Js.Re.exec("foo", re);
  ...
  describe("find", () => {
    test("match", () => 
      expect(Revamp.Compiled.find(re, "mangos and bananas")) |> toEqual(Some("ang")));
  ...
  describe("findIndex", () => {
    test("match", () => 
      expect(Revamp.Compiled.findIndex(re, "mangos and bananas")) |> toEqual(Some((1, 4))));
  
    test("no match", () => 
      expect(Revamp.Compiled.findIndex(re, "apples and pears")) |> toBe(None));
  });
  
  describe("replace", () => {
    test("match", () => 
      expect(Revamp.Compiled.replace(re, _x => "foo", "mangos and bananas")) |> toEqual("mfooos and bfoos"));
  
    test("no match", () => 
      expect(Revamp.Compiled.replace(re, _x => "foo", "apples and pears")) |> toEqual("apples and pears"));
  });
  
  describe("replaceByString", () => {
    test("match", () => 
      expect(Revamp.Compiled.replaceByString(re, "[$1]", "mangos and bananas")) |> toEqual("m[an]os and b[an]s"));
  
    test("no match", () => 
      expect(Revamp.Compiled.replaceByString(re, "[$1]", "apples and pears")) |> toEqual("apples and pears"));
  });
  ...
  describe("split", () => {
    ...
    test("no match", () => 
      expect(Revamp.Compiled.split(re, "apples")) |> toEqual([|"apples"|]));
  });
});
...
describe("Uncompiled", () => {
  ...
  describe("exec", () => {
    ...
    test("flags", () => 
      expect(
        Revamp.exec(pattern, ~flags=[IgnoreCase], "Mangos and Bananas") |> Seq.map(Revamp.Match.match) |> List.fromSeq)
        |> toEqual(["ang", "anana"]));
  });
  ...
  describe("matches", () => {
    ...
    test("flags", () => 
      expect(
        Revamp.matches(pattern, ~flags=[IgnoreCase], "Mangos and Bananas") |> List.fromSeq)
        |> toEqual(["ang", "anana"]));
  });
  ...
  describe("indices", () => {
    ...
    test("flags", () => 
      expect(
        Revamp.indices(pattern, ~flags=[IgnoreCase], "Mangos and Bananas") |> List.fromSeq)
        |> toEqual([(1, 4), (12, 17)]));
  });
  ...
  describe("captures", () => {
    ...
    test("flags", () => 
      expect(
        Revamp.captures(pattern, ~flags=[IgnoreCase], "Mangos and Bananas") |> List.fromSeq)
  ...
  describe("test", () => {
    ...
    test("flags", () => 
      expect(Revamp.test(pattern, ~flags=[IgnoreCase], "Mangos and Bananas")) |> toBe(true));
  });
  ...
  describe("count", () => {
    ...
    test("flags", () => 
      expect(Revamp.count(pattern, ~flags=[IgnoreCase], "Mangos and Bananas")) |> toBe(2));
  });
  ...
  describe("find", () => {
    ...
    test("flags", () => 
      expect(Revamp.find(pattern, ~flags=[IgnoreCase], "Mangos and Bananas")) |> toEqual(Some("ang")));
  });
  ...
  describe("findIndex", () => {
    ...
    test("findIndex", () => 
      expect(Revamp.findIndex(pattern, ~flags=[IgnoreCase], "Mangos and Bananas")) |> toEqual(Some((1, 4))));
  });
  ...
  describe("replace", () => {
    ...
    test("flags", () => 
      expect(Revamp.replace(pattern, _x => "foo", ~flags=[IgnoreCase], "Mangos and Bananas")) |> toEqual("Mfooos and Bfoos"));
  });
  ...
  describe("replaceByString", () => {
    ...
    test("flags", () => 
      expect(Revamp.replaceByString(pattern, "[$1]", ~flags=[IgnoreCase], "Mangos and Bananas")) |> toEqual("M[an]os and B[an]s"));
  });
  ...
  describe("split", () => {
    ...
    test("flags", () => 
      expect(Revamp.split(" |!", ~flags=[IgnoreCase], "bang bang bananabatman!")) |> toEqual(([|"bang", "bang", "bananabatman", ""|])));
  });
});